...
public class SysDeptController {
	...
	@GetMapping("getDeptAllPersion")
	@ApiOperation("列表")
	public Result<List<SysDeptAllPersionDTO>> getDeptAllPersion(){
		List<SysDeptAllPersionDTO> deptAllPersion = sysDeptService.getDeptAllPersion(SecurityUser.getUserId());
		return new Result<List<SysDeptAllPersionDTO>>().ok(deptAllPersion);
	}
