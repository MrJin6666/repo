...
import com.goboosoft.modules.busininspect.excel.BusinInspectionCorrectionMxExcel;
 ...
 */
@RestController
@RequestMapping("demo/busininspectioncorrectionmx")
@Api(tags="业务 - 整改明细信息表")
public class BusinInspectionCorrectionMxController {
    ...
    @RequiresPermissions("demo:busininspectioncorrectionmx:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("demo:busininspectioncorrectionmx:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("demo:busininspectioncorrectionmx:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("demo:busininspectioncorrectionmx:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("demo:busininspectioncorrectionmx:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("demo:busininspectioncorrectionmx:export")
